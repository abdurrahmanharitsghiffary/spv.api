...
const checkIsParticipatedInChatRoom = ({ body = "", params = "", shouldAlsoBlockSendingMessageToGroupChat = false, }) => (0, handler_middlewares_1.tryCatchMiddleware)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    const { userId } = req;
    ...
    if ((chatRoom === null || chatRoom === void 0 ? void 0 : chatRoom.isGroupChat) && !shouldAlsoBlockSendingMessageToGroupChat)
        return next();
    if (!((_e = (_d = chatRoom === null || chatRoom === void 0 ? void 0 : chatRoom.participants) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.userId))
...
exports.checkMessageAccess = (0, handler_middlewares_1.tryCatchMiddleware)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!((_g = (_f = message === null || message === void 0 ? void 0 : message.chatRoom.participants) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.userId)) {
